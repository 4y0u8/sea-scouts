    ...
    <Container>
      ...
      <AboutSection id="about">
        ...
        <AboutContainer>
          ...
          <AboutContent>
            <AboutText>
              الفوج البحري سيدي بوعلي هو مؤسسة تربوية بحرية تأسست عام 2005 بهدف تنمية مهارات الشباب البحرية وربطهم بتراثهم البحري. نعمل على بناء شخصية متوازنة من خلال برامج متكاملة تجمع بين التدريب البحري المتخصص والأنشطة التربوية.
            </AboutText>
            <AboutText>
